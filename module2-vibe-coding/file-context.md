...
화면 왼쪽의 **파일 탐색기**에서 `data` 폴더를 찾아주세요.

![파일 탐색기에서 data 폴더 찾기](../.gitbook/assets/placeholder-find-data-folder.png)

> **잠깐! 💡**
> `data` 폴더가 안 보이시나요?
> - 파일 목록을 위아래로 스크롤해보세요
> - 폴더가 접혀있을 수 있어요. ▶ 화살표를 클릭해보세요

### 1-2. 규정 파일 열어보기

`data` 폴더를 클릭해서 열면 안에 파일이 있습니다.
...
![regulations.md 파일을 열어서 내용을 확인하는 화면](../.gitbook/assets/placeholder-regulations-file-content.png)
...
![프롬프트에서 @data/regulations.md를 입력하는 모습 - 파일 목록 드롭다운이 나타남](../.gitbook/assets/placeholder-at-file-autocomplete.png)
...
![Before - @파일 연결 전의 일반적인 답변](../.gitbook/assets/placeholder-before-at-file.png)
...
![After - @파일 연결 후의 데이터 기반 답변](../.gitbook/assets/placeholder-after-at-file.png)

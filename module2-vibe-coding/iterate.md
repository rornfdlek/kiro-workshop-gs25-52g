...
![배경이 밝은 회색으로 바뀌고 채팅 영역이 카드 형태로 변경된 모습](../.gitbook/assets/placeholder-design-background-card.png)
...
> **잠깐! 💡**
> 브라우저에 변화가 안 보이나요?
> - **Live Server**를 사용 중이면 **자동으로 새로고침**됩니다
...
![헤더가 파란색 배경 흰 글자로 바뀌고 부제목이 추가된 모습](../.gitbook/assets/placeholder-design-header-blue.png)
...
![예시 버튼이 둥근 알약 모양으로 바뀐 모습](../.gitbook/assets/placeholder-design-pill-buttons.png)
...
![로딩 애니메이션이 표시되는 모습 - 점 3개가 깜빡이는 화면](../.gitbook/assets/placeholder-loading-animation.png)
...
![질문 예시 버튼이 5개로 늘어난 모습](../.gitbook/assets/placeholder-more-example-buttons.png)
...
![현재 답변 스타일 스크린샷 - Before 상태](../.gitbook/assets/placeholder-steering-before.png)
...
![파일 탐색기에서 .kiro 폴더 안의 steering.md 파일 찾기](../.gitbook/assets/placeholder-find-steering-file.png)
...
![변경된 답변 스타일 스크린샷 - After 상태](../.gitbook/assets/placeholder-steering-after.png)
...
2. Module 1에서 작성한 **원래 내용**으로 되돌립니다
